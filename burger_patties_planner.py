...
with st.form("planner"):
    ...
    c3, c4 = st.columns(2)
    reg_in_stock = c3.number_input("Regular patties left in stock", min_value=0, step=1, value=2)
    mini_in_stock = c4.number_input("Mini patties left in stock", min_value=0, step=1, value=4)
